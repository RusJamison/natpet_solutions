...
from products.models import Manufacturer, Product, Category
...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'price': forms.NumberInput(attrs={
                'class': 'form-control', 'step': '0.01', 'min': '0.00'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['categories'].required = False  # ManyToMany optional
...
class CategoryForm(forms.ModelForm):
    ...
    class Meta:
        model = Category
        fields = ['name']  # Excluding search_vector as managed automatically
        widgets = {
...
class ManufacturerForm(forms.ModelForm):
    ...
    class Meta:
        model = Manufacturer
        fields = ['name', 'description']  # Search managed automatically
        widgets = {
            'name': forms.TextInput(attrs={
                'class': 'form-control',
...
class CouponForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if valid_from and valid_from < timezone.now().date():
            raise forms.ValidationError("Valid from date cannot be in the past")
