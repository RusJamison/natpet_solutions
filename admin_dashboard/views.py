...
class AdminDashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        total_price = Order.objects.aggregate(Sum("total_amount_paid"))[
        ...
        context["total_paid_orders"] = total_paid_orders
        return context
...
class AdminCategoryDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.object.delete()
        messages.success(
            request, f"Category '{category_name}' deleted successfully.")
        return HttpResponseRedirect(self.get_success_url())
...
class AdminManufacturerDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(
            request,
            f"Manufacturer '{manufacturer_name}' deleted successfully."
        )
        return HttpResponseRedirect(self.get_success_url())
...
class AdminOrderDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.object.delete()
        messages.success(
            request, f"Order '{category_name}' deleted successfully.")
        return HttpResponseRedirect(self.get_success_url())
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(
                request,
                self.template_name,
                {"coupon_form": form, "coupons": self.get_queryset(),
                 'errors': errors},
            )
...
class AdminCouponDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.object.delete()
        messages.success(
            request, f"Coupon '{category_name}' deleted successfully.")
        return HttpResponseRedirect(self.get_success_url())
